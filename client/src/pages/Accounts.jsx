...
export default function Accounts() {
  ...
  return <>
    <PageHeader title="Accounts" subtitle="Oracle-controlled balances, available funds, and account status" action={user.role !== "CUSTOMER" && <button className="btn-primary" onClick={() => setOpen(!open)}>Open account</button>} />
